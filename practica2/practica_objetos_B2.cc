...
// tipos
typedef enum{CUBO, PIRAMIDE, OBJETO_PLY, ROTACION, EXTRUSION, RECTANGULO, CILINDRO, CONO, ESFERA, PLY_ROTACION, PLY_ROTACION2} _tipo_objeto;
...
_rectangulo rectangulo(1.5,0.5,1.0);
_cilindro cilindro(2.0,5.0,20);
_cono cono(2.0,5.0,20);
_esfera esfera(10.0,5,10);
_objeto_ply_rotacion ply_rotacion;
_objeto_ply_rotacion ply_rotacion2;
...
switch (t_objeto){
	...
	case RECTANGULO: rectangulo.draw(modo, 1.0, 0.0,0.0,5);break;
	...
	case PLY_ROTACION: ply_rotacion.draw(modo, 1.0,0.0,0.0,5);break;
	case PLY_ROTACION2:ply_rotacion2.draw(modo,1.0,0.0,0.0,5);break;
	}
}
...
switch (toupper(Tecla1)){
	...
	case '4':modo=SOLID_COLORS;break;
		...
		case 'L':t_objeto=RECTANGULO;break;
		case 'I':t_objeto=CILINDRO;break;
		case 'K':t_objeto=CONO;break;
		case 'E':t_objeto=ESFERA;break;
		case 'A':t_objeto=PLY_ROTACION;break;
		case 'V':t_objeto=PLY_ROTACION2;break;
	}
glutPostRedisplay();
}
...
rotacion.parametros(perfil,3,1,1);
...
// Tapa in, tapa su
ply_rotacion.parametros_rotacion(argv[2],1,1);
ply_rotacion2.parametros_rotacion(argv[3],1,0); 	// Al ser una copa no quiero que tenga tapa superior
