...
// tipos
typedef enum{CUBO, PIRAMIDE, OBJETO_PLY, ROTACION, CILINDRO, CONO, ESFERA, EXTRUSION, EXCAVADORA, SILLA, GLOBO} _tipo_objeto;
...
_cono cono(1,2,6);
_esfera esfera(2,20,20);
_excavadora excavadora;
_extrusion *extrusion;
_globoCompleto globoCompleto;
// _silla silla;
...
switch (t_objeto){
	...
	case PIRAMIDE: piramide.draw(modo,1.0,0.0,0.0,5);break;
        ...
        // case SILLA: silla.draw(modo,1.0,0.0,0.0,5);break;
        case GLOBO:globoCompleto.draw(modo,1.0,0.0,0.0,5);break;
	}
...
switch (toupper(Tecla1)){
	...
	case '4':modo=SOLID_COLORS;break;
        ...
        // case 'S':t_objeto=SILLA;break;
        case 'G':t_objeto=GLOBO;break;
	}
glutPostRedisplay();
}
...
rotacion.parametros(perfil,6,1,1,0,"negro");
